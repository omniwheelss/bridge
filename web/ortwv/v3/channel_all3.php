            ...
            <div id="Output_Div">
                <div id="muldiv">
                    <div class="pod_header">
	                    <div class="lastProductName" onclick="Create_New_POI()" style="text-align:center; cursor:pointer"><b>Create POI</b></span>( I know latitude and longitude )</div>
                    </div>
                    <center>
             ...
             document.write('<div id="map" style="width:100%; height:450px; margin-top:10px; float:left">') ;
             </script>
             <script language="javascript">
