<?php
 ...
 include("Lib/Includes.php"); 
	...
	?>
            ...
            <tr>
                <td style="font-size:14px; padding:10px 0 10px 5px;" align="center"><b>POI History Report for the Vehicle  <?=$Get_VehicleNos[$IMEI]?></b><br /><br /><b>Available data from </b><?=$From_Date_Db?>&nbsp; <b>to </b><?=$To_Date_Db?><br /></td>
            </tr>
            <tr>
...
<?
		$currDate = gmdate("d_M_Y");  
	 	$fName = "POI_History_Report_for_the_account_".$Cook_Username."_On_".$currDate.".xls";
