			...
			<form name="history_map" method="post" onsubmit="return check_dates(7)">
          	<div id="muldiv">
                <div class="pod_header"><p style="padding-top:2px">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <input type="submit" name="Report_POI" value="&nbsp;&nbsp; Show POI History &nbsp;&nbsp;"  style="color:#000000">
       <?php
			if(isset($_REQUEST['Report_POI'])){
				...
				if(count($Get_IMEIS) >= 1){
					...
					if($Total_Record > 0){
			?>
					<a href="poi-history-report-all-excel-ajax.php?IMEI=<?=$IMEI?>&Start_Date=<?=$Start_Datetime?>&End_Date=<?=$End_Datetime?>"><img src="images/excel.png" height="25" width="25" class="excel-icon"  /></a>
