...
<?php
	...
	$Sel_Query1 = "SELECT * FROM DEVICE_DATA_VIEW where  Account_ID = '".$Cook_Account_ID."' and Date_Stamp between '".$_REQUEST['Start_Date']."' and '".$_REQUEST['End_Date']."' order by Date_Stamp";
        ...
        <tr>
            ...
            <div class="space-10"></div>
			  ...
			  $Excel_Output='
                <tr style="background-color:#EFEFEF">
                    ...
                    <td style="font-size:14px; font-weight:bold; padding:10px 0 10px 5px;" align="left"><b>Vehicle</b></td>
            ...
            while($Sel_Record = mysql_fetch_array($Sel_Result1))
            {
                ...
                <tr>
                    ...
                    <td style="font-size:13px; font-weight:normal; padding:3px 0 3px 5px; color:#333333; background-color:#ffffff;" align="left">'.$Vehicle_No.'</td>
...
<?
		$currDate = gmdate("d_M_Y");  
	 	$fName = "History_Location_Report_On_".$currDate.".xls";
