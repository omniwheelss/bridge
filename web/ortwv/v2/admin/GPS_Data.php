<?php
	...
	$Order_By = "Record_Index desc"; // Column name to be order and which order (asc or desc)
	$Records_Per_Page = 100;
	$Pagination_No_Count = 10;
	$Edit_ID_Column = "Record_Index"; // Unique value should be give for whatever query you do in that table
	...
	$Form_Fields[] = array('1','1','From Date','From','','','E|N|0','','Filter_box','Cal_T','','F','Date_Stamp');
	$Form_Fields[] = array('1','1','To Date','To','','','E|N|0','','Filter_box','Cal_T','','T','Date_Stamp');
	...
	$Search_Fields = array('IMEI','Latitude','Longitude','Speed','Date_Stamp','Server_Date_Stamp');

	//List Fields
	$List_Fields[] = array('IMEI','IMEI','','','');
	$List_Fields[] = array('Latitude','Latitude','','','');
	$List_Fields[] = array('Longitude','Longitude','','','');
	$List_Fields[] = array('Speed','Speed','','','');
	$List_Fields[] = array('Course','Course','','','');
	$List_Fields[] = array('Ignition','IGN','','','');
	$List_Fields[] = array('Date Stamp','Date_Stamp','','2','');
	$List_Fields[] = array('Server Date Stamp','Server_Date_Stamp','','2','');
