<?php
	...
	$Order_By = "Device_Type_ID desc"; // Column name to be order and which order (asc or desc)
	$Records_Per_Page = 20;
	$Pagination_No_Count = 2;
	$Edit_ID_Column = "Device_Type_ID"; // Unique value should be give for whatever query you do in that table
	...
	$Search_Fields = array('Device_Type','Description');

	//List Fields
	$List_Fields[] = array('Device Type','Device_Type','','','');
