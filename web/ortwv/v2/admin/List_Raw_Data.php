<?php
	...
	if (isset($_REQUEST["XLS"])){$XLS=1;}else{$XLS=0;}
		...
		$Icons_Control = "|||X|P"; // Delete / Edit / View / Excel / Print
	...
	//List Fields
	$List_Fields[] = array('RAW DATA','Raw_Data','','','');
...
-->                    <? } ?>
					...
					?>
                    <? if($XLS == 0){
							echo '<td class="admin-menu-heading"><div align="left"><a title="Locate"><strong>Locate</strong>&nbsp;</a></div></td>';
                    } ?>
			  	</tr>
				<tr>
				...
				<?php
					...
					while($Fetch_Result = mysql_fetch_array($Result)){
						...
						echo $Display_List[] = "<tr class='$Row_Cls' height='25'>";
							...
							// Locate Code				
							echo "<td class='Row_Td' width='30px'><a href='Locate_Map.php?RI_ID=".$Fetch_Result['Record_Index']."' target='_New'><img src='./images/track.gif' /></a></td>";	
							echo "</tr>";
