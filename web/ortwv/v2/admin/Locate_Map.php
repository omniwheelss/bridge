		...
		<div id="admin_left">
   		<p class="headings"><?=$Title_Head?></p>
			...
			<?
                ...
                // Select query
                $Sel_Query = "SELECT * FROM DEVICE_DATA where Record_Index = '".$_REQUEST['RI_ID']."'";
		...
		<table border="1" cellpadding="5" cellspacing="3" width="90%" style="margin:10px;background-color:#E3E3E3; border-collapse:collapse; border-color:#CCCCCC">
            ...
            (function () {
              ...
              function initialize() {
                ...
                var a = new Array();
            <?
                $Map_Name = "<div><table cellpadding='3' cellspacing='3' style='font-size:12px; width:250px;float:left;'><tr><td align='left' valign='top' width='50px' colspan='2' style='color:red;'><b>Location Details</b></td></tr><tr><td align='left' valign='top' width='50px'><b>Date</b> </td><td align='left' valign='top'>". date("d-M-Y", strtotime($Date_Stamp))." ".$Time_Stamp." </td></tr><tr><td align='left' valign='top'><b>Location</b></td><td align='left' valign='top'>".$Location_Name."</td></tr></table></div>";	
            ?>
                var t =  new Object();
