<?php
	...
	//Select
	$Form_Fields[] = array('2','2','Device Type ID','Device_Type_ID',$Device_Type_Array,'*','1','selectcls','','----- Device Type -----','1');

	$Form_Fields[] = array('1','1','SIM No','SIM_No','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Phone No','Phone_No','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Vehicle No','Vehicle_No','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Device ID','Device_ID','','*','E|N|0','','txtbox','','');
	//Select
