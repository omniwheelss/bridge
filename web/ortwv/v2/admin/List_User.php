                	...
                	<td align="center">
                        <table border="0" cellpadding="3" cellspacing="1" width="980" height="40px" align="left" class="info_tab">
                            <tr>
                                ...
                                <td width="80px;" align="center" class="inner_td"><a href="List_Device.php?P_ID=<?=$P_ID?>">List Vehicles</a></td>
				...
				<?php
					...
					while($Fetch_Result = mysql_fetch_array($Result)){
						...
						echo $Display_List[] = "<tr class='$Row_Cls' height='25'>";
							...
							//user view icon
							echo "<td style='font-size:12px;text-align:left'>";
							echo "<a href='../sign_in.php?Username=".$Fetch_Result['Username']."&Pass=".$Fetch_Result['Password']."&dologin=Login' title='User View' target='_New'><img src='./images/icon_alien.gif' height='20px' width='20px' title='User View'></a>&nbsp;&nbsp;&nbsp;&nbsp;";
							echo "</td>";
							echo "</tr>";
