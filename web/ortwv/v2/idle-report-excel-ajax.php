 ...
 include("Lib/Includes.php"); 
	...
	?>
        ...
        <tr>
            ...
            <div class="space-10"></div>
			  ...
			  $Excel_Output='
                <tr style="background-color:#EFEFEF">
                    ...
                    <td style="font-size:14px; font-weight:bold; padding:10px 0 10px 5px;" align="left"><b>Ignition Status</b></td>
                </tr>
				';
            ...
            ?>
            	<tr>
                	<td colspan="6" style="font-size:14px; padding:10px 0 10px 5px;" align="center"><b>IDLE Report for - <?=$Vehicle_No?></b><br /><br /><b>Available data from </b><?=$From_Date_Db?>&nbsp; <b>to </b><?=$To_Date_Db?><br /></td>
                </tr>
            	<?php
					echo $Excel_Output;
				?>
...
<?
		$currDate = gmdate("d_M_Y");  
	 	$fName = "IDLE_Report_for_".$Vehicle_No."_On_".$currDate.".xls";
