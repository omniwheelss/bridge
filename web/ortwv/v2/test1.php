...
?>
    ...
    <div class="con-mid">
       ...
       ?>
             ...
             <br /><br /><br /><br /><br /><br />
<center>
<div id='poi_creation'><table border='0' cellpadding='3' cellspacing='3'><tr><td colspan='2'><div class='poi-head'>Create Geo Fence</div></td></tr><tr><td class='poi-txt'>Name</td><td><input class='forminputtext' name='Name' type='text'><input class='poi_txt' name='Point' value='" + map.getCenter(point) +"' type='hidden'></td></tr><tr><td colspan='2'><input class='poi-sub' type='button' value='Create Your POI' onclick='Poi_Creation()'></td></tr></table></div></center><div id='poi-ajax'><br />Loading...</div></center>

<center>
<div id='poi_thankyou'><table border='0' cellpadding='3' cellspacing='3'><tr><td colspan='2'><div class="poi-head">Thank you</div></td></tr><tr><td class='poi-txt'>Thanks for submitting the POI values.</td></tr></table></div></center>            
